...
type GetConfigVersionNosRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetConfigVersionNosRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetConfigVersionNosResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// version_id → version_no. Absent id ⇒ unresolved (caller emits -1).
	VersionNos    map[int64]int64 `protobuf:"bytes,1,rep,name=version_nos,json=versionNos,proto3" json:"version_nos,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConfigVersionNosResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_tipsy_config_v1_config_proto_rawDesc = "" +
	...
	"\x0fcreated_at_unix\x18\x05 \x01(\x03R\rcreatedAtUnixJ\x04\b\x03\x10\x04R\vchange_note\"=\n" +
	"\x1aGetConfigVersionNosRequest\x12\x1f\n" +
	"\vversion_ids\x18\x01 \x03(\x03R\n" +
	"versionIds\"\xbb\x01\n" +
	"\x1bGetConfigVersionNosResponse\x12]\n" +
	"\vversion_nos\x18\x01 \x03(\v2<.tipsy.config.v1.GetConfigVersionNosResponse.VersionNosEntryR\n" +
	"versionNos\x1a=\n" +
	"\x0fVersionNosEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	...
	"\x17NAMESPACE_KIND_BUSINESS\x10\x012\xcc\a\n" +
	"\rConfigService\x12L\n" +
