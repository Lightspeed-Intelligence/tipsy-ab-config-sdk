...
public final class AbtestContext {
    ...
    AbtestComputeResult getExperimentResultForNamespace(String ns) {
        ...
        GetExperimentResultRequest req = GetExperimentResultRequest.newBuilder()
                ...
                .setExperimentType(io.tipsy.abconfig.proto.abtest.v1.ExperimentType.EXPERIMENT_TYPE_CONFIG_VERSION)
                .setDisplayType(io.tipsy.abconfig.proto.abtest.v1.ResultDisplayType.RESULT_DISPLAY_TYPE_FLAT_KV)
                .setTraceId(traceId)
                .build();
        try {
