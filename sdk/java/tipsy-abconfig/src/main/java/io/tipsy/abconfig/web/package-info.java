 ...
 * {@link io.tipsy.abconfig.AbtestContext}.</b> Build one per inbound request via
 ...
 * <ul>
 *   <li>{@link io.tipsy.abconfig.web.AbtestContextHolder} — a {@code ThreadLocal}
 *       holder. <b>Does NOT propagate across virtual-thread / executor
 *       fan-out</b>; see its Javadoc.</li>
 *   <li>{@link io.tipsy.abconfig.web.HttpServerSupport} — thin helpers for the JDK
