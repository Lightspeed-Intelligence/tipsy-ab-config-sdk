...
import io.tipsy.abconfig.Transport;
import io.tipsy.abconfig.proto.config.v1.ConfigServiceGrpc;
import io.tipsy.abconfig.proto.config.v1.ConfigUpdateEvent;
import io.tipsy.abconfig.proto.config.v1.PullAllRequest;
import io.tipsy.abconfig.proto.config.v1.PullAllResponse;
import io.tipsy.abconfig.proto.config.v1.SubscribeRequest;
import java.io.IOException;
import java.time.Duration;

/**
 * A minimal in-process {@link TipsyAbConfigClient} factory for the
 * {@code io.tipsy.abconfig.web} tests.
 *
 * <p>The ST6 web helpers operate on real {@link io.tipsy.abconfig.AbtestContext}
 * instances, but that class's constructor is package-private to
 * {@code io.tipsy.abconfig}, so a test in THIS package cannot {@code new} one. The
