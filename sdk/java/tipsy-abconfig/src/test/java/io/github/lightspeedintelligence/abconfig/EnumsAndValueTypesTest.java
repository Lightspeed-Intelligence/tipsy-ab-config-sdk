...
final class EnumsAndValueTypesTest {
    ...
    void experimentTypeWireValuesMatchProto() {
        assertEquals(0, io.github.lightspeedintelligence.abconfig.ExperimentType.UNSPECIFIED.wireValue());
        assertEquals(1, io.github.lightspeedintelligence.abconfig.ExperimentType.CONFIG_VERSION.wireValue());
        assertEquals(2, io.github.lightspeedintelligence.abconfig.ExperimentType.CUSTOM_PARAMS.wireValue());
        assertEquals(3, io.github.lightspeedintelligence.abconfig.ExperimentType.ALL.wireValue());

        assertEquals(ExperimentType.EXPERIMENT_TYPE_UNSPECIFIED.getNumber(),
                io.github.lightspeedintelligence.abconfig.ExperimentType.UNSPECIFIED.wireValue());
        assertEquals(ExperimentType.EXPERIMENT_TYPE_CONFIG_VERSION.getNumber(),
                io.github.lightspeedintelligence.abconfig.ExperimentType.CONFIG_VERSION.wireValue());
        assertEquals(ExperimentType.EXPERIMENT_TYPE_CUSTOM_PARAMS.getNumber(),
                io.github.lightspeedintelligence.abconfig.ExperimentType.CUSTOM_PARAMS.wireValue());
        assertEquals(ExperimentType.EXPERIMENT_TYPE_ALL.getNumber(),
                io.github.lightspeedintelligence.abconfig.ExperimentType.ALL.wireValue());
    }

    @Test
    @DisplayName("ResultDisplayType wireValue() matches proto numbers")
    void resultDisplayTypeWireValuesMatchProto() {
        assertEquals(0, io.github.lightspeedintelligence.abconfig.ResultDisplayType.UNSPECIFIED.wireValue());
        assertEquals(1, io.github.lightspeedintelligence.abconfig.ResultDisplayType.FLAT_KV.wireValue());
        assertEquals(2, io.github.lightspeedintelligence.abconfig.ResultDisplayType.EACH_EXPERIMENT_GROUP.wireValue());

        assertEquals(ResultDisplayType.RESULT_DISPLAY_TYPE_UNSPECIFIED.getNumber(),
                io.github.lightspeedintelligence.abconfig.ResultDisplayType.UNSPECIFIED.wireValue());
        assertEquals(ResultDisplayType.RESULT_DISPLAY_TYPE_FLAT_KV.getNumber(),
                io.github.lightspeedintelligence.abconfig.ResultDisplayType.FLAT_KV.wireValue());
        assertEquals(ResultDisplayType.RESULT_DISPLAY_TYPE_EACH_EXPERIMENT_GROUP.getNumber(),
                io.github.lightspeedintelligence.abconfig.ResultDisplayType.EACH_EXPERIMENT_GROUP.wireValue());
    }
    ...
    void requestBuilderDefaults() {
        ...
        assertEquals(io.github.lightspeedintelligence.abconfig.ResultDisplayType.UNSPECIFIED, req.displayType());
    ...
    void requestBuilderRetainsFields() {
        ...
        assertSame(io.github.lightspeedintelligence.abconfig.ResultDisplayType.EACH_EXPERIMENT_GROUP, req.displayType());
